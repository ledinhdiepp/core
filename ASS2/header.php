  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          ...
          <li <?php if(!isset($_SESSION['type_login'])){ echo "style=\"display:none\"";} ?> class="drop-down"><a href="">profile</a>
            <ul>
              <li><a href="Thongtin.php" <?php if(!isset($_SESSION['type_login']) or ($_SESSION['type_login']!=1) or !check_info()){ echo "style=\"display:none\"";} ?> > THÔNG TIN CÁ NHÂN </a></a></li>
              <li><a href="themthongtin.php" <?php if(!isset($_SESSION['type_login']) or ($_SESSION['type_login']!=1) or check_info()){ echo "style=\"display:none\"";} ?> > THÊM THÔNG TIN CÁ NHÂN</a></li>
              <li><a href="login.php" <?php if(!isset($_SESSION['type_login'])){ echo "style=\"display:none\"";} ?> > ĐĂNG XUẤT </a></li>
            </ul>
          </li>
        </ul>
